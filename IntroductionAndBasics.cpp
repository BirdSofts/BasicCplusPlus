...
void HelloWorld ()
{
    try
    {
        ...
        /* block
        comment*/
        std::cout << "\nHello World! "; // inserting an output
...
void VariablesAndTypes ()
{
    try
    {
        ...
        // #######################################
        //--- define in one line plus initialization in different revisions
        std::cout << "\n----- Definition and initialization of variables in different revisions:\n";
        ...
        std::cout << "a: " << a << '\t' << "b: " << b << '\t' << "Result: " << result << std::endl; // endl: flushes the stream and prints the newline character
        ...
        // #######################################
        //--- deduction of type: auto and decltype shall mainly be used when the type can't be determined or for improving the readability. the example below is non of them.
        std::cout << "\n----- Deduction of type:\n";
        int int_var { 0 };
        auto aut_var { int_var }; // same as int aut_var{ int_var }
        decltype( int_var ) dec_var { int_var }; // same as int dec_var
        std::cout << "Normal declaration and initialization: " << int_var << std::endl;
        std::cout << "Using auto for declaration: " << aut_var << std::endl;
        std::cout << "Using decltype for declaration:" << dec_var << "\n";

        // #######################################
        //--- fundamental types: char
        std::cout << "\n----- Fundamental types: char" << std::endl;
        ...
        wchar_t ch4 { 'A' }; // std::wstring (supposed to store ucs4 or any other 32-bit encoding, dose it on Linux/Unix, but stores utf-16 on Windows for backwards compatibility)
        std::cout << "wchar_t: " << static_cast<char>( ch4 ) << "\n";

        // #######################################
        //--- fundamental types: int
        std::cout << "\n----- Fundamental types: int" << std::endl;
        signed char num1_1 { -128 }; // one byte: -128 to 127
        ...
        std::cout << "\n----- Fundamental types: float" << std::endl;
        ...
        std::cout << "\n----- Fundamental other types: bool, ..." << std::endl;
        bool bool_var { true };
        ...
        // there is no variable of type void.
        ...
        // #######################################
        //--- strings: the class string is one of the compound types in C++.
        // header file is <string>.
        std::cout << "\n----- The compound types: string class." << std::endl;
...
void Constants ()
{
    try
    {
        ...
        // in the statement "i=5;" 5 is the literal constant.
        std::cout << "\n~~~~~ Constants:\n";
        std::cout << "The most obvious kind of constants are literals.\n";

        // #######################################
        //--- integer numerals: (C++ allows the use of numbers in octal or hexadecimal base)
        std::cout << "\n----- Integer constants: \n";
        ...
        // like variables literal constants have types.
        ...
        // #######################################
        //--- floating point numerals: expressing real values which can include either decimal point or "e" character
        // "e" character stands for exponents, isn't case-sensitiv and expresses "by ten at the Xth height" where "X" is an integer value that follows "e".
        // modification of types: the suffixes characters used below, aren't case-sensitiv.
        ...
        // #######################################
        //--- character and string literals: these are enclosed in quotes.
...
paRTed"  " And "		  "wriTTen In TreeLine" };
        ...
        // #######################################
        //--- other literals: in C++ there are 3 more keyword literals. true, false and nullptr.
        // nullptr is the null pointer value.
        std::cout << "\n----- Other keyword constants: \n";
        const bool con24 { false };
        std::cout << "A boolean constant:\t" << con24 << "\n";
        const int *p { nullptr };

        // #######################################
        //--- typed constant expressions: for convenience sake because some literals will often be repeated in source code. an example:
        ...
        // #######################################
        //--- preprocessor definitions (#define): another way to define constant values
